...
export function FeatureLinks({ 
  ...
  return (
    <div className="bg-brand-50 rounded-lg p-4 my-6">
      <h4 className="font-medium text-brand-900 mb-3">
        {title}
      </h4>
      <ul className="space-y-2">
        {featureItems.map((item) => (
          <li key={item.href}>
            <Link 
              href={item.href}
              className="text-brand-700 hover:text-brand-900 text-sm font-medium hover:underline"
            >
              → {item.title}
            </Link>
          </li>
