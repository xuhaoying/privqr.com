...
const BentoCard = ({
  ...
  <div
    ...
    className={cn(
      ...
      // dark styles
      "transform-gpu bg-white border border-gray-200 shadow-lg",
      // hover effects
  ...
  >
    ...
    <div className="pointer-events-none z-10 flex transform-gpu flex-col gap-1 p-6 transition-all duration-300 group-hover:-translate-y-10">
      <Icon className="h-12 w-12 origin-left transform-gpu text-neutral-900 transition-all duration-300 ease-in-out group-hover:scale-75" />
